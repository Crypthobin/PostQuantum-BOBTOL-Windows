...
void CExtBOBPubKey::Encode(unsigned char code[BIP32_EXTPQKEY_SIZE]) const
{
    ...
    //memcpy(code + 41, pubkey.begin(), CBOBPubKey::COMPRESSED_SIZE);
...
// CExtBOBKey
//
//void CExtBOBPubKey::Encode(unsigned char code[BIP32_EXTKEY_SIZE]) const
//{
//    code[0] = nDepth;
//    memcpy(code + 1, vchFingerprint, 4);
//    code[5] = (nChild >> 24) & 0xFF;
...
//}
//
//void CExtBOBPubKey::Decode(const unsigned char code[BIP32_EXTKEY_SIZE])
//{
//    nDepth = code[0];
//    memcpy(vchFingerprint, code + 1, 4);
//    nChild = (code[5] << 24) | (code[6] << 16) | (code[7] << 8) | code[8];
