...
static RPCHelpMan deriveaddresses()
{
    ...
    return RPCHelpMan{
        ...
        RPCExamples{"First three native segwit receive addresses\n" + HelpExampleCli("deriveaddresses", "\"" + EXAMPLE_DESCRIPTOR + "\" \"[0,2]\"") + HelpExampleRpc("deriveaddresses", "\"" + EXAMPLE_DESCRIPTOR + "\", \"[0,2]\"")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
...
static RPCHelpMan echo(const std::string& name)
{
    return RPCHelpMan{
        ...
        "bobtol-cli and the GUI. There is no server-side difference.",
        {
    ...
    return RPCHelpMan{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            if (interfaces::Ipc* ipc = local_init.ipc()) {
                ...
                // IPC support is not available because this is a bobtold
                // process not a bobtold-node process, so just create a local
